            ...
            <div className="flex -space-x-[6px] overflow-hidden">
              {task.assignee && (
                <Image
                  ...
                  src={`https://pms3images-ms.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
              ...
              {task.author && (
                <Image
                  ...
                  src={`https://pms3images-ms.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl!}`}
                  alt={task.author.username}
                  width={30}
                  height={30}
                  className="oboject-cover dark:border-dark-secondary h-8 w-8 rounded-full border-2 border-white"
                />
              )}
            </div>
